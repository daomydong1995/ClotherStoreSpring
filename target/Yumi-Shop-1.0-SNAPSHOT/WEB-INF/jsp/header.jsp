...
<div class="agileits_header">
  <div class="container">
    <div class="w3l_offers">
      <p>Sản phẩm đang giảm giá tới 70% "SALE70%" . <a href="/product">SHOP NOW</a></p>
    </div>
    ...
    <nav class="navbar navbar-default">
      ...
      <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav">
          ...
          <!-- Mega Menu -->
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><spring:message code="hello"
                                                                                       text="default text"/><b
                class="caret"></b></a>
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><spring:message code="supplier"
                                                                                       text="default text"/><b
                class="caret"></b></a>
            <ul class="dropdown-menu multi-column columns-3">
              <h6>All Household</h6>

          ...
          <div class="content table-responsive table-full-width">
            ...
            <table class="table table-hover table-striped">
              ...
              <c:forEach items="${categoryList}" var="categoryList">
                <tr>
                  <td>${categoryList.idCategory}</td>
                  <td>${categoryList.name}</td>
                  <td>${categoryList.nameVN}</td>
                  <td>
                    <a href="/admin/editCategory?id=${categoryList.idCategory}"><img
                        src="/resources/assets/img/icon/edit.svg " height="20" width="20"></a></td>
                  <td><a href="/delete/${categoryList.idCategory}"><img src="/resources/assets/img/icon/delete.svg "
                                                                        height="20"
                                                                        width="20"></a></td>
                </tr>
              </c:forEach>
            ...
            <table class="table table-hover">
              ...
              <c:forEach items="${supplierList}" var="supplierList">
                <tr>
                  ...
                  <td>
                    <a href="/admin/editsuppliers?id=${supplierList.idSupplier}"><img
                        src="/resources/assets/img/icon/edit.svg " height="20" width="20"></a></td>
                  <td><a href="/deletesup/${supplierList.idSupplier}"><img src="/resources/assets/img/icon/delete.svg "
                                                                           height="20"
                                                                           width="20"></a></td>
